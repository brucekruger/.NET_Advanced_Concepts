...
/// <summary>
/// Controller for managing cart operations V2.
/// </summary>
[ApiController]
[ApiVersion("2.0")]
...
public class CartController : ControllerBase
{
    ...
    // GET api/v2/cart/34f57c9a-b66f-46a6-87a4-8d6aa1a072fd
    /// <summary>
    /// Retrieves cart information for the specified cart ID.
    /// </summary>
    /// <param name="id">The unique identifier of the cart.</param>
    /// <returns>The list of cart items if found; otherwise, a not found or bad request response.</returns>
    [HttpGet("{id}")]
    ...
    try
    {
        ...
        return CreatedAtAction(nameof(GetCartInfo), new { id = createdCartItem.Id, version = "2.0" }, createdCartItem);
    }
    catch (Exception ex)
    {
        return BadRequest(ex);
    ...
    // DELETE api/v2/cart/34f57c9a-b66f-46a6-87a4-8d6aa1a072fd/5
    /// <summary>
